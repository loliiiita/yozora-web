...
function __maketitle($b1, $b2) {
	...
	<meta property="og:title"              content="$b1 - $b2"/>
	...
	echo '<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
				<div class="container">
					<div class="navbar-header">
						...
						global $isBday;
						echo $isBday ? '<a class="navbar-brand" href="/"><i class="fa fa-birthday-cake"></i><img src="/images/logos/text-new.png" style="display: inline; padding-left: 10px;"></a>' : '<a class="navbar-brand logo" href="/"><img src="/images/logos/text-new.png"></a>';
					echo '</div>
...
//		echo '<li><a href="/p/3"><i class="fa fa-plus-circle"></i>	Sign up</a></li>';
//		if ($isBday) echo '<li><a href="/blog"><b><i class="fa fa-birthday-cake" ></i>	Happy birthday!</a></b></li>';
		echo '<li><a href="/leaderboard"><i class="fa fa-trophy"></i>	Leaderboard</a></li>';
		echo '<li class="dropdown">
					<a data-toggle="dropdown"><i class="fa fa-question-circle"></i>	Help & Info<span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li class="dropdown-submenu"><a href="/p/23"><i class="fa fa-gavel"></i>	Rules</a></li>
						<li class="dropdown-submenu"><a href="/p/14"><i class="fa fa-question-circle"></i>	Help</a></li>
	...
	if (checkLoggedIn()) {
		...
		echo '<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li class="dropdown-submenu"><a href="/p/23"><i class="fa fa-gavel"></i> Rules</a></li>
						<li class="dropdown-submenu"><a href="/p/35"><i class="fa fa-star"></i> Yozora Team</a></li>
						<li class="dropdown-submenu"><a href="/p/14"><i class="fa fa-question-circle"></i>	Help</a></li>
						'.(file_exists(dirname(__FILE__).'/../blog/anchor/config/db.php') ? '<li class="dropdown-submenu"><a href="blog/"><i class="fa fa-anchor"></i>	Blog</a></li>' : '').'
						<li class="dropdown-submenu"><a href="/p/31"><i class="fa fa-music"></i>	Request beatmap ranking</a></li>
						<li class="divider"></li>
						<li class="dropdown-submenu"><a href="/p/17"><i class="fa fa-code"></i> Changelog</a></li>
	...
	if (checkLoggedIn()) {
		...
		echo '<li class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li class="dropdown-submenu"><a href="/p/7"><i class="fa fa-lock"></i>	Change password</a></li>
						<li class="dropdown-submenu"><a href="/p/8"><i class="fa fa-pencil"></i> Edit userpage</a></li>
						<li class="dropdown-submenu"><a href="/p/6"><i class="fa fa-cog"></i>	User settings</a></li>
						<li class="divider"></li>
							';
	...
	echo '<div id="sidebar-wrapper" class="collapse" aria-expanded="false">
					<ul class="sidebar-nav">
						...
						if (hasPrivilege(Privileges::AdminManageUsers)) {
							...
							echo '<li><a href="/p/132"><i class="fa fa-fire"></i>	Anticheat reports</a></li>';
						}

						if (hasPrivilege(Privileges::AdminWipeUsers)) {
							echo '<li><a href="/p/134"><i class="fa fa-undo"></i>	Restore scores</a></li>';
						}
...
function getUserCountry() {
	...
	$data = get_contents_http("http://ip.zxq.co/$ip");
...
function getChangelog() {
	...
	if (!file_exists(dirname(__FILE__).'/../../ci_meme/changelog_site.txt')) {
...
function getChangelogPage($p = 1) {
	...
	$data = explode("\n", file_get_contents(dirname(__FILE__).'/../../ci_meme/changelog_site.txt'));
	$ret = [];
