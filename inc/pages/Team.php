		...
		<div id="content">
			<div align="center">
				...
				echo '<hr><h3><i class="fa fa-heart"></i>	Special thanks</h3>
					...
					<div class="small-br"></div>
					<i class="fa fa-circle fa-bullet-list"></i>	<b><a href="https://twitter.com/jacksonisiahpro">Jackson Isaiah (jacksonisiah)</a></b>, for Yozora\'s logo, help out with original community moderation and initially paying for the server that Yozora was/is running on.
					<div class="small-br"></div>
