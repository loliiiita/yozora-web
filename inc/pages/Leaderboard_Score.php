...
class Leaderboard_Score {
	...
	public function P() {
		...
		echo "<a href='/leaderboard'>Regular</a> | <a href='/relaxboard'>Relax</a> | <b><a href='/scoreboard'>Score</a></b> | <a href='/autoboard'>AutoPilot</a>";
		...
		foreach ($leaderboard as $lbUser) {
			...
			echo '<td><img src="/images/flags/'.$country.'.png"/>	<a href="/u/'.$lbUser['id'].'&m='.$m.'">'.$lbUser['username'].'</a></td>
			<td>'.$score.'</td>
